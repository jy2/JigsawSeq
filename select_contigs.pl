...
print "[Report:select_contigs] $num_process contigs were processed and $num_pass contigs were passed (cutoff: CV <= $criteria)";
if ($num_pass > 0) {
    print "Average depth of passed contigs = ", ($sum_ave / $num_pass), "\n\n";
}else{
    print "\n\n";
}
exit;
